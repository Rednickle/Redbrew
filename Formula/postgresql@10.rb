class PostgresqlAT10 < Formula
  ...
  bottle do
    sha256 "366f1eeb324e064dc0dc7feb2daec0c516cd8f3efcdaeacf5dd3ac18b09e3eef" => :catalina
    ...
    sha256 "f558a2915ac1255115b0ad577b768ddd1eee457661c533313013ed348791dc0f" => :x86_64_linux
  end
  ...
  def install
    ...
    ENV.prepend "LDFLAGS", "-L#{Formula["openssl@1.1"].opt_lib} -L#{Formula["readline"].opt_lib} -R#{lib}/postgresql" if OS.mac?

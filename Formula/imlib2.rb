class Imlib2 < Formula
  ...
  url "https://downloads.sourceforge.net/project/enlightenment/imlib2-src/1.6.0/imlib2-1.6.0.tar.bz2"
  ...
  bottle do
    ...
    sha256 "743a033df0ce614be7d74877a23bdfb94461c1e8dfe411df3acd8c90d5045e54" => :x86_64_linux
  end

class AppEngineGo64 < Formula
  ...
  if OS.mac?
    ...
    url "https://storage.googleapis.com/appengine-sdks/featured/go_appengine_sdk_linux_amd64-1.9.59.zip"
    sha256 "98cb172ac4de583b8f5f7a8f32b9117ff1ed0739b7ef9900e46497e12c365056"
  end

class AppEngineGo64 < Formula
  ...
  if OS.mac?
    ...
    url "https://storage.googleapis.com/appengine-sdks/featured/go_appengine_sdk_linux_amd64-1.9.48.zip"
    sha256 "62232bf68cf544b2695d6599c0740d481d998148bed683ce954715ddc8584c2a"
  end

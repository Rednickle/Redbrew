class AppEngineGo64 < Formula
  ...
  if OS.mac?
    ...
    url "https://storage.googleapis.com/appengine-sdks/featured/go_appengine_sdk_linux_amd64-1.9.57.zip"
    sha256 "bd4136de7ef8a5001ca1050238999e9ff45d696ffcb60c4f5e851687dd8deee7"
  end

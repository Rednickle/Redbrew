class AppEngineGo64 < Formula
  ...
  if OS.mac?
    ...
    url "https://storage.googleapis.com/appengine-sdks/featured/go_appengine_sdk_linux_amd64-1.9.40.zip"
    sha256 "d6ed91500f2d31ffc2e0dab3da58881ff88aa99d7c04b2ecafbc8eb32e86d578"
  end

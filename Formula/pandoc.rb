...
class Pandoc < Formula
  ...
  url "https://hackage.haskell.org/package/pandoc-2.8/pandoc-2.8.tar.gz"
  ...
  bottle do
    ...
    sha256 "c0a14414e5a2ea644d5e727274e335a3d5ad2e6e2b7f88b9ac0c90a303f11259" => :x86_64_linux
  end

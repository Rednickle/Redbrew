class MariadbAT100 < Formula
  ...
  url "https://downloads.mariadb.org/f/mariadb-10.0.38/source/mariadb-10.0.38.tar.gz"
  ...
  bottle do
    ...
    sha256 "f52c95a835d2c436e7cdde654f588dd14068b389c99ac1cefca021b2f5836269" => :x86_64_linux
  end

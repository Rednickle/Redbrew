class Sbcl < Formula
  ...
  url "https://downloads.sourceforge.net/project/sbcl/sbcl/1.5.5/sbcl-1.5.5-source.tar.bz2"
  ...
  bottle do
    ...
    sha256 "a752021216254d6712a74d70d0a083c23e542c8c7c31193f5b3324ea8a3713e9" => :x86_64_linux
  end

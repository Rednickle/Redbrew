class Sbcl < Formula
  ...
  url "https://downloads.sourceforge.net/project/sbcl/sbcl/1.5.2/sbcl-1.5.2-source.tar.bz2"
  ...
  bottle do
    ...
    sha256 "47d4bb800dc8c3c38940d2723ca3533e766c915254bcaf5f704077143034acc9" => :x86_64_linux
  end

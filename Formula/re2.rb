class Re2 < Formula
  ...
  bottle do
    ...
    sha256 "d135fdd14fe293b667558027bbbd4e7f78916b31e73ad273f3ec9102b4207fd3" => :x86_64_linux
  end
  ...
  def install
    ...
    MachO::Tools.change_dylib_id("#{lib}/libre2.6.0.0.dylib", "#{lib}/libre2.0.dylib") if OS.mac?
    ext = OS.mac? ? "dylib" : "so"
    lib.install_symlink "libre2.6.0.0.#{ext}" => "libre2.0.#{ext}"
    lib.install_symlink "libre2.6.0.0.#{ext}" => "libre2.#{ext}"
  end

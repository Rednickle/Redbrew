class Remake < Formula
  ...
  bottle do
    sha256 "7eca51d8dbc43ec7f6bf9466f25cbe8b25f6a267def2125c0b1a4c686f85368a" => :mojave
    ...
    sha256 "da2edc5a2c6e3089a797f80e1cdb644c2fe43be07522056b1f322025e4e03fce" => :x86_64_linux
  end

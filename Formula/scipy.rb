class Scipy < Formula
  ...
  bottle do
    ...
    sha256 "271529df18afbdd61919fd69a10fc1be81ea204ac042281db318dfae25112cc0" => :x86_64_linux
  end
  ...
  def install
    ...
    system "python3", "setup.py", "build", (OS.mac? ? "--fcompiler=gnu95" : "--fcompiler=gfortran")

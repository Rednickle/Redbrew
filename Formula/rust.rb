class Rust < Formula
  ...
  resource "cargobootstrap" do
    if OS.mac?
      ...
      # From: https://github.com/rust-lang/rust/blob/#{version}/src/stage0.txt
      url "https://static.rust-lang.org/dist/2019-05-14/cargo-0.35.0-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "1dc3cb681ee275433f3cf751e5736d097b54470e9208dfea18d8ce5505935795"
    end
  end

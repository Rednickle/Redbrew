class GdkPixbuf < Formula
  ...
  url "https://download.gnome.org/sources/gdk-pixbuf/2.36/gdk-pixbuf-2.36.8.tar.xz"
  ...
  bottle do
    ...
    sha256 "c0dbee3173477440ac3423b0b219df7987b976fd5fa4d61da8f97b5a738bdb44" => :x86_64_linux
  end

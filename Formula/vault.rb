...
class Vault < Formula
  ...
  bottle do
    ...
    sha256 "1602f221a0709aed0cdfa43fc25a7e86a154bd67dae03316168997d0574c0f6a" => :mojave
    ...
    sha256 "600eb5d7061d462a30f74700027f2142d886446a28891448f2a6f51d5f320bd8" => :x86_64_linux
  end

class Aurora < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 "a7172659a88ebc1a9e7d7c5324d7205b537e3c8a20bbeaa3932b918c6ecd8ad3" => :catalina
    ...
    sha256 "c294944d18dca63f3bcfef77c92990c27abb05f705cf7027a9d3fe817a6424e6" => :x86_64_linux
  end

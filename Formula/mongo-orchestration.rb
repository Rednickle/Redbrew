class MongoOrchestration < Formula
  ...
  bottle do
    ...
    sha256 "271513e272623600b25417b908f07bba8cf299660349916faa4a3900043ff37f" => :mojave
    ...
    sha256 "a34ef34e562414a1a7e9af9f3ea82f67f1f3ba6181af40883caa815566c93959" => :x86_64_linux
  end

...
class BalenaCli < Formula
  ...
  bottle do
    ...
    sha256 "fe6d5f2536f5f758c1d5e4148b6685920177637cd5ab3c30368fd8cdee4a8ad2" => :x86_64_linux
  end

  depends_on "node"

  def install
    system "npm", "install", *("--unsafe-perm" if ENV["CI"]), *Language::Node.std_npm_install_args(libexec)

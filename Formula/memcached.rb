class Memcached < Formula
  ...
  bottle do
    ...
    sha256 "cc3cd63b13a9f23202b5e736c3b12d81f0d367609515e855cb31fed1f0eed828" => :x86_64_linux
  end
  ...
  test do
    ...
    system bin/"memcached", "--listen=127.0.0.1:11211", "--daemon", "--pidfile=#{pidfile}"
    sleep 1
